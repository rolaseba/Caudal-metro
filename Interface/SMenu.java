...
{
  static PApplet app; 
  static SMenu actm=null; 
  static PFont font; 
  static actn action=null;
  String nam; 
  actn act=null; 
  SMenu m,par; 
  Rectangle r,rm; int vis=-1;
  ...
  SMenu(PApplet ap,String s,int mx,int my) 
  {
    ...
    {
      app=ap; actm=this; 
      font=app.createFont("Arial",17);  // Defino la fuente y tamaño de la misma usada en el menú
      app.registerDraw(this); 
      app.registerMouseEvent(this);
      if (nam.equals("Main")) 
       app.mouseY=-1; //to avoid appearing main menu at startup 
